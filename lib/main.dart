...
import 'package:flutter_application_1/pages/mainScreen.dart'; // From HEAD
import 'package:flutter/services.dart' show rootBundle; // From homepage
import 'dart:convert'; // From homepage
import 'package:cloud_firestore/cloud_firestore.dart'; // From homepage
import 'package:firebase_core/firebase_core.dart'; // From both
import 'firebase_options.dart'; // From both
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/login', // Start with the question screen
      routes: {
